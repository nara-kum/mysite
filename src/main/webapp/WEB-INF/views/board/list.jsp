					...
					<div class="paging">
						<ul class="clearfix">
							<c:if test="${requestScope.pMap.prev}">
								<li><a href="${pageContext.request.contextPath}/board/list?crtpage=${requestScope.pMap.startPgaeBtnNo-1}">◀</a></li>
							</c:if>
							...
							<c:if test="${requestScope.pMap.next}">
								<li><a href="${pageContext.request.contextPath}/board/list?crtpage=${requestScope.pMap.endPageBtnNo+1}">▶</a></li>
							</c:if>
						</ul>
					</div>
					<!-- 세션에 값이 있을때 -->
